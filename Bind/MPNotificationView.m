...
#define kMPNotificationHeight    55.0f
...
//        _contentView.layer.cornerRadius = 8.0f;
        ...
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(1, 1, 50, 50)];
        _imageView.contentMode = UIViewContentModeScaleAspectFill;
        _imageView.layer.cornerRadius = 4.0f;
        _imageView.clipsToBounds = YES;
        [self addSubview:_imageView];
        
        UIFont *textFont = [UIFont fontWithName:@"Avenir-Black" size:16.0f];
        ...
        UIFont *detailFont = [UIFont fontWithName:@"Avenir-Roman" size:15.0f];
